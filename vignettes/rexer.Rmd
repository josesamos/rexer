...
The result of the first generated exam in both versions is included in the package, in the files `01.pdf` and `01c.pdf`.

Below is the beginning of both documents. Although the correction support document does not indicate the answers (as they were not provided in the exercise definition), we can see that the gaps are marked with the selected options.


```{r, echo = FALSE, fig.align = 'center', out.width = "100%"}
knitr::include_graphics("figures/01.png")
knitr::include_graphics("figures/01c.png")
```
